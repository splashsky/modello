...
Download the `.zip` or clone the project using Git. A Composer-ready package is coming soon. Move the `Modello.php`class file to wherever you want to. In the script you need to use Modello in, `require` it.
